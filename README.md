...
Production-grade, cross-region VPC peering provisioned entirely with Terraform.
...
- Multi-region Terraform provider aliasing
- Cross-region VPC peering (requester + accepter pattern)
- Explicit bidirectional route table configuration
- Security group design for east-west traffic
...
- Public subnets in separate AWS regions
- Internet gateways per VPC
- Cross-region peering connection
- EC2 instances for end-to-end private IP connectivity testing
- Apache bootstrapped via user data
...
Cross-region networking is foundational for:

- Multi-region application architectures
- Disaster recovery patterns
- Shared services models
- Migration strategies
- Transit Gateway evolution

This project focuses on the networking layer — the part most engineers avoid but senior engineers must understand deeply.
